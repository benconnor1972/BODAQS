...
describe("findDisplacementColumn", () => {
  it("finds front engineering displacement column", () => {
    expect(findDisplacementColumn(COLUMNS, "front", false)).toBe("front_wheel_disp_dom_wheel [mm]");
  });
  ...
  it("finds rear engineering displacement column", () => {
    expect(findDisplacementColumn(COLUMNS, "rear", false)).toBe("rear_wheel_disp_dom_wheel [mm]");
  });
...
describe("prepareMetricScatter", () => {
  ...
  it("extracts front compression scatter points", () => {
    const result = prepareMetricScatter(
      metrics,
      "compression",
      "front",
      "m_peak_disp_max",
