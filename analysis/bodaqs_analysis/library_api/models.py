...
def default_capabilities() -> dict[str, Any]:
    return {
        ...
        "features": {
            ...
            "read_session_video_attachments": True,
            "write_session_video_attachments": True,
            "stream_session_video_attachments": True,
            "select_local_video_files": True,
            "write_session_descriptions": True,
            "query_signals": True,
            "query_events": True,
            "query_metrics": True,
            "query_event_definitions": True,
            "query_event_segments": True,
            "read_event_annotations": True,
            "write_event_annotations": True,
            "read_spatial_context_windows": True,
            "read_scenarios": True,
            "write_scenarios": True,
            "evaluate_scenarios": True,
