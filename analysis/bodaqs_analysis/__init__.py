...
_EXPORTS: dict[str, tuple[str, str]] = {
    ...
    "bdq_to_stream_dataframes": (".io_bdq", "bdq_to_stream_dataframes"),
    "is_bdq_path": (".io_bdq", "is_bdq_path"),
    "iter_bdq_rows": (".io_bdq", "iter_bdq_rows"),
    "iter_bdq_stream_records": (".io_bdq", "iter_bdq_stream_records"),
    "iter_bdq_time_observations": (".io_bdq", "iter_bdq_time_observations"),
    "build_imu_streams": (".imu", "build_imu_streams"),
    "extract_imu_stream": (".imu", "extract_imu_stream"),
    "imu_qc_report": (".imu", "imu_qc_report"),
    "AttitudeConfig": (".attitude", "AttitudeConfig"),
    "build_attitude_stream": (".attitude", "build_attitude_stream"),
    "build_attitude_streams": (".attitude", "build_attitude_streams"),
    "estimate_attitude": (".attitude", "estimate_attitude"),
