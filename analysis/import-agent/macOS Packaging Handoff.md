...
- Manager GUI entrypoint: `analysis/bodaqs_import_agent_setup.py`
- CLI/import-agent entrypoint: `analysis/bodaqs_import_agent_cli.py`
- Manager implementation: `analysis/bodaqs_analysis/import_agent_setup.py`
...
- Startup integration, currently Windows-focused: `analysis/bodaqs_analysis/import_agent_startup.py`
- Tray/menu integration, currently Windows-gated: `analysis/bodaqs_analysis/import_agent_tray.py`
- App/source/library provisioning: `analysis/bodaqs_analysis/import_agent_provisioning.py`

Existing Windows packaging references:

- PyInstaller manager spec: `analysis/bodaqs_import_agent_setup.spec`
- PyInstaller CLI spec: `analysis/bodaqs_import_agent_cli.spec`
- Windows build script: `analysis/build_import_agent.ps1`
- Inno Setup installer script: `analysis/import-agent/windows/bodaqs_import_agent_windows.iss`
- Windows installer docs: `analysis/documentation/BODAQS_Import_Agent_Windows_Installer_v1.md`

Branding and default assets:

- Logo source of truth: `bodocs/public/favicon.svg`
- Branding generation helper: `analysis/import-agent/generate_import_agent_branding.py`
- Runtime app icon PNG: `analysis/bodaqs_analysis/import_agent_assets/app_icon.png`
- Runtime app icon ICO: `analysis/bodaqs_analysis/import_agent_assets/app_icon.ico`
- Tray icon PNG: `analysis/bodaqs_analysis/import_agent_assets/tray_icon.png`
- Windows ICO: `analysis/import-agent/windows/bodaqs_import_agent.ico`
- Seeded import-source defaults: `analysis/bodaqs_analysis/import_agent_assets/`

Planning document already in the repo:

- `analysis/import-agent/Phase 6 macOS Plan.md`
...
- `analysis/bodaqs_import_manager_macos.spec`
...
- package data: `collect_data_files("bodaqs_analysis.import_agent_assets")`
- hidden imports:
...
1. Add `analysis/import-agent/macos/`.
