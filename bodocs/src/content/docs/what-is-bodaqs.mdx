...
- We have [sourcing](/logger-build-guide/bodaqs-a8/sourcing-hardware/), [building](/logger-build-guide/bodaqs-a8/building-the-logger/), and [user](/user-guide/) guides.
- We have published packages for the [hardware](https://github.com/benconnor1972/BODAQS/tree/main/hardware/releases) and the 3d printed [case](https://github.com/benconnor1972/BODAQS/tree/main/mechanical/Case/a8_v1_0)
