...
This build guide is getting a makeover in the run up to publication of the A8 design. It may have a few rough edges just now.
</Aside>

<Lightbox thumbnailWidth={600} src="/src/assets/pics/logger-build-guide/f_vs_a8_outside.jpg" alt="Build-overview"/>
...
<Lightbox thumbnailWidth={600} src="/src/assets/pics/logger-build-guide/f_vs_a8_inside.jpg" alt="Build-overview"/>
