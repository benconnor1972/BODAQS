...
description: Full parts list for building the Prototype F logger.
sidebar:
  order: 1
---
...
<Aside type={"caution"} title="These materials are for the Prototype F logger"  icon="seti:config">
    The following materials work for the Prototype F logger. If you are building the BODAQS A8 logger, start [here](/logger-build-guide/bodaqs-a8/sourcing-hardware/)
</Aside>
...
Go to the 'releases' page in the BODAQS github repository [here](https://github.com/benconnor1972/BODAQS/tree/main/hardware/prototype-f/fab) and download the latest PCB fabrication package. The package contains all the files you need to order an assembled PCB from JLCPCB.
...
<Aside type="tip" title="Ordering tips">
...
<Flag src="/src/assets/pics/logger-build-guide/thing_plus_s3.png" alt="Dev board ">
...
<Flag src="/src/assets/pics/logger-build-guide/qwiic.png" alt="qwiic connector cable">
...
All the print files are available [here](https://github.com/benconnor1972/BODAQS/tree/main/mechanical/Case/Prototype%20E-F). (The Fusion CAD model of the case is in the 'f3z' directory). 
...
#### Multi-meter
<Badge text="Recommended" variant="caution"/> For polarity & continuity testingm and fault finding. Even a basic model is sufficient for the needs of this project. Not needed if everything goes perfectly. (You'll probably need one)
