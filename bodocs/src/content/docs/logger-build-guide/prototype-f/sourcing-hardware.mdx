...
<Aside type={"caution"} title="These materials are for Prototype F"  icon="seti:config">
    The following materials work for Prototype version F (the materials are the same for Prototype E but we recommend building Prototype F).
</Aside>
