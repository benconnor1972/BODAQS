---
title: Importing log files with BODAQS Import Manager
...
<Lightbox thumbnailWidth={600} src="/src/assets/pics/software-guide/import-manager.png" alt="BODAQS Import Manager main window"/>
...
<Lightbox thumbnailWidth={600} src="/src/assets/pics/software-guide/import-manager.png" alt="Import Manager window"/>
...
<Flag src="/src/assets/pics/user-guide/source-context-menu.png" alt="source context menu">
...
<Flag src="/src/assets/pics/user-guide/import-run-naming.png" alt="import run naming">
...
<Flag src="/src/assets/pics/user-guide/import-session-naming.png" alt="import session naming">
...
<Lightbox thumbnailWidth={600} src="/src/assets/pics/software-guide/import-manager-2.png" alt="provision tab"/>
...
<Lightbox thumbnailWidth={600} src="/src/assets/pics/user-guide/wifi-discover-loggers.png" alt="provision tab"/>
...
<Lightbox thumbnailWidth={600} src="/src/assets/pics/software-guide/bike-profile-complete.png" alt="Completed bike profile editor"/>
...
<library>/syn/
```
<Lightbox thumbnailWidth={600} src="/src/assets/pics/user-guide/synoutputs.png" alt="data.syn.bike export outputs"/>
...
<Lightbox thumbnailWidth={600} src="/src/assets/pics/user-guide/remove-source.png" alt="remove-source"/>
