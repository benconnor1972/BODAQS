...
Go to the 'releases' page in the BODAQS github repository [here](https://github.com/benconnor1972/BODAQS/hardware/releases) and download the latest PCB fabrication package. The package contains all the files you need to order an assembled PCB from JLCPCB.
