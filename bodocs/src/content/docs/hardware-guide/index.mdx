...
<Aside title="Optional">
  There are two variants of the case design. One is designed to be fixed closed using brass heat-set inserts in the lower half of the case. This is cosmetically superior, but requires you to have the inserts. The alternative is to use standard 3mm hex nuts. This works just as well but doesn't look quite so tidy.
