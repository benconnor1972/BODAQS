...
<Flag src="/src/assets/pics/hardware_1.png" alt="hardware_1">
First, [create an account](https://passport.jlcpcb.com/#/login) at JLCPCB (or log in if you already have an account). Then Select 'order now' from the top right of the [home screen](jlcpcb.com).
</Flag>

<Flag src="/src/assets/pics/hardware_2.png" alt="hardware_2">
...
<Flag src="/src/assets/pics/hardware_3.png" alt="hardware_3">
...
<Flag src="/src/assets/pics/hardware_4.png" alt="hardware_4">
...
<Flag src="/src/assets/pics/hardware_5.png" alt="hardware_5">
You will be presented with the Bill of Materials and Component Placements. Click 'next' on each page.
</Flag>

<Flag src="/src/assets/pics/hardware_6.png" alt="hardware_6">
...
<Flag src="/src/assets/pics/thing_plus_s3.png" alt="Dev board ">
...
#### 0.96” OLED display
<Flag  src="/src/assets/pics/OLED.png" alt="OLED pic">
...
<Lightbox src="/src/assets/pics/OLED_dims.png" alt="OLED dims" />


#### 5-key membrane keypad
<Flag src="/src/assets/pics/keypad.png" alt="keypad ">
...
#### Li-ion battery
<Flag src={"/src/assets/pics/battery.png"} alt="battery">
...
<Aside type={"caution"} title="Always check polarity before connecting">
  ...
  <Lightbox thumbnailWidth={400} src={"/src/assets/pics/correct_polarity.png"} alt="battery polarity example showing correct and incorrect polarity"/>
...
<Flag src="/src/assets/pics/qwiic.png" alt="qwiic connector cable">
...
<Lightbox src="/src/assets/pics/male_3_pin.png" alt="male 3 pin " />
<Lightbox src="/src/assets/pics/male_4_pin.png" alt="male 4 pin " />
...
<Flag src="/src/assets/pics/plugs.png" alt="plugs">
...
<Flag src="/src/assets/pics/print-case.png" alt="print-case">
...
<Flag src="/src/assets/pics/print-plate.png" alt="print-plate">
**BambuLab-format project files** are also available in the '3mf' directory. `all parts - one material.3mf` has all the parts on a single plate - delete the base and ends variants you don't need. `all parts - three colors.3mf` is the same but has alternate filament colors assigned to the logo inlays. 
</Flag>



### Sensors
<Flag src="/src/assets/pics/linear_pots.png" alt="Linear Potentiometers">
...
<Lightbox src="/src/assets/pics/soldering_iron_1.png" alt="A generic soldering iron" />
<Lightbox src="/src/assets/pics/soldering_iron_2.png" alt="sThe TS101 premium iron" />
...
<Lightbox src="/src/assets/pics/sidecutters.png" alt="side cutter " />
...
<Lightbox src="/src/assets/pics/wire_strippers.png" alt="wire stripper " />
...
<Lightbox src="/src/assets/pics/multimeter.png" alt="multimeter " />
...
<Lightbox src="/src/assets/pics/hot_air.png" alt="hot air gun" />

### Minor components and consumables
In addition, you will need:
- Some light-gauge (22, 24 or 26 gauge) hookup wire, preferably in four colors – less than a metre in total. You can get this from electronics hobby shops, online, or scavenge it from an old network cable. {/* <Lightbox src="/src/assets/pics/wire.png" alt="wire pic" /> */}
- 2.5mm shrink-sleeve for covering soldered joints{/*<Lightbox src="/src/assets/pics/shrink.png" alt="shrink pic" />*/}
- Silicone sealant, for waterproofing {/*<Lightbox src="/src/assets/pics/silicone.png" alt="silicone pic" />*/}
