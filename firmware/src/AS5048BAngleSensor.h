...
class AS5048BAngleSensor : public Sensor, public I2CAsyncClient {
public:
  ...
  explicit AS5048BAngleSensor(const Params& p);
  ...
  const char* asyncClientKind() const override { return "as5048b_angle_i2c"; }
...
private:
  ...
  mutable uint8_t m_lastDiagnostic = 0;
