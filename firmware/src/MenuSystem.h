...
namespace MenuSystem {
  ...
  enum class State : uint8_t { Inactive, Main, Settings, SensorsList, RatePicker, LogFormatPicker, WiFiModePicker, UploadStatus, CalibSensors, CalibDetail, SagHelper, Health, About };
