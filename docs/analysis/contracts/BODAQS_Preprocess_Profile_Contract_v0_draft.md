...
- Bike-profile/post-processing transforms are applied unless `prefer_postprocessing_transformations` is false and a logger-originated signal with equivalent output semantics already exists.
