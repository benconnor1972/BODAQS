...
1. Use [`bodaqs_batch_preprocessor.ipynb`](../../../analysis/bodaqs_batch_preprocessor.ipynb) to process logger CSV files into canonical artifacts.
2. Optionally, use [`BODAQS_library_manager.ipynb`](../../../analysis/BODAQS_library_manager.ipynb) to curate descriptions, notes, and create aggregations.
3. Use the dashboard and widget notebooks to consume the artifact library:
   - [`bodaqs_simple_suspension_metrics.ipynb`](../../../analysis/bodaqs_simple_suspension_metrics.ipynb)
   - [`bodaqs_simple_suspension_metrics_persisted_scope.ipynb`](../../../analysis/bodaqs_simple_suspension_metrics_persisted_scope.ipynb)
   - [`bodaqs_data_explorer.ipynb`](../../../analysis/bodaqs_data_explorer.ipynb)
   - [`bodaqs_session_browser.ipynb`](../../../analysis/bodaqs_session_browser.ipynb)
4. Optionally, use [`bodaqs_event_schema_test_harness.ipynb`](../../../analysis/bodaqs_event_schema_test_harness.ipynb) to develop and test event definitions.
...
Notebook: [`bodaqs_batch_preprocessor.ipynb`](../../../analysis/bodaqs_batch_preprocessor.ipynb)
...
- **Contracts / documentation:** the selector behavior is aligned with the artifact discovery model in [`BODAQS_analysis_artifacts_specification_v0_2.md`](../contracts/BODAQS_analysis_artifacts_specification_v0_2.md).
...
- **Contracts / documentation:**
  - [`BODAQS_Session_Schema_v0_1.md`](../contracts/BODAQS_Session_Schema_v0_1.md)
  - [`BODAQS_Minimum_Signal_Registry_Semantics_v0_1_1.md`](../contracts/BODAQS_Minimum_Signal_Registry_Semantics_v0_1_1.md)
...
- **Contracts / documentation:** [`BODAQS_analysis_artifacts_specification_v0_2.md`](../contracts/BODAQS_analysis_artifacts_specification_v0_2.md)

## `BODAQS_library_manager.ipynb`

Notebook: [`BODAQS_library_manager.ipynb`](../../../analysis/BODAQS_library_manager.ipynb)
...
- **Contracts / documentation:**
  ...
  - [`../../templates/session_note_templates/README.md`](../../../analysis/templates/session_note_templates/README.md)
...
Notebook: [`bodaqs_simple_suspension_metrics.ipynb`](../../../analysis/bodaqs_simple_suspension_metrics.ipynb)
...
- **Contracts / documentation:** [`BODAQS_session_selector_consumer_widgets_contract.md`](../contracts/BODAQS_session_selector_consumer_widgets_contract.md)

## `bodaqs_simple_suspension_metrics_persisted_scope.ipynb`

Notebook: [`bodaqs_simple_suspension_metrics_persisted_scope.ipynb`](../../../analysis/bodaqs_simple_suspension_metrics_persisted_scope.ipynb)
...
Notebook: [`bodaqs_data_explorer.ipynb`](../../../analysis/bodaqs_data_explorer.ipynb)
...
- **Contracts / documentation:**
  - [`BODAQS_session_selector_consumer_widgets_contract.md`](../contracts/BODAQS_session_selector_consumer_widgets_contract.md)
  - [`bodaqs_bookmarks_spec_v1.md`](../contracts/bodaqs_bookmarks_spec_v1.md)

## `bodaqs_session_browser.ipynb`

Notebook: [`bodaqs_session_browser.ipynb`](../../../analysis/bodaqs_session_browser.ipynb)
...
Notebook: [`bodaqs_event_schema_test_harness.ipynb`](../../../analysis/bodaqs_event_schema_test_harness.ipynb)
