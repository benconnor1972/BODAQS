...
#
# macOS PyInstaller spec for BODAQS Library Service.
#
# Produces a one-dir console bundle that is placed inside the manager .app
# bundle at Contents/Resources/service/ by the build script.
#
# Run from the import-manager directory:
#
#   cd import-manager
...
#
# Output: dist/pyinstaller/bodaqs-library-service/bodaqs-library-service
...
service_version = os.environ.get("BODAQS_LIBRARY_SERVICE_VERSION", "").strip()
