...
- `import-manager/packaging/macos/bodaqs_import_agent.icns`
...
- `bodaqs_import_manager.import_agent_startup`
- Windows-only tray gating in `bodaqs_import_manager.import_agent_tray`
- Windows-focused packaging/build flow in `import-manager/build_import_manager.ps1`
- Inno Setup packaging in `import-manager/packaging/windows/`
