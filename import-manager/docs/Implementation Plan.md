...
- first non-tray manager slice implemented in `bodaqs_import_manager.import_agent_setup`
...
- concrete planning note written at `import-manager/docs/Phase 6 macOS Plan.md`
