...
```powershell
python import-manager\bodaqs_import_agent_setup.py
```

Packaged Windows build target:

```powershell
.\import-manager\build_import_manager.ps1 -Target setup
```

Output bundle:

```text
import-manager/dist/pyinstaller/bodaqs-import-setup/
```
...
```text
import-manager/dist/installer/windows/
```
