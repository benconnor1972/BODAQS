...
#
# Linux PyInstaller spec for the BODAQS Import Manager. Produces a portable
# one-directory bundle; build_import_manager_linux.sh adds the library service
# and Workbench web files beneath this bundle before it is archived.
